...
using ConnectionProvider.Identity.Abstraction;
using ConnectionProvider.Identity.Context;
using ConnectionProvider.Identity.Entities;
using ConnectionProvider.Identity.Helpers;
using ConnectionProvider.Identity.Options;
using ConnectionProvider.Identity.Security.Token;
using ConnectionProvider.Identity.Services;
...
namespace ConnectionProvider.Identity.IoC
{
